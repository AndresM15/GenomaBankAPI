...
public class ChromosomesController {
    ...
    public ChromosomesController(IChromosomesService ichromosomesService) {
        this.ichromosomesService = ichromosomesService;
    ...
    public ResponseEntity<List<ChromosomeOutDTO>> listarCromosomas(
        ...
        List<ChromosomeOutDTO> cromosomas = ichromosomesService.listarCromosomas(genomeId);
